    ...
    return <div className="page">
        <div className="content">
            <Card>
                ...
                <Radio firstChild title={t("annuity")} value="annuity" checked={type === "annuity"}
                       onChange={() => setType("annuity")}/>
                <Radio lastChild title={t("differentiated")} value="differentiated" checked={type === "differentiated"}
                       onChange={() => setType("differentiated")}/>
            </Card>
            <Input title={t("loanProductAmount") + ":"} id="sum" placeholder="0" onChange={handleSum} type="text"
                   inputmode="numeric"/>
            <Input title={t("percentagePerAnnum") + ":"} id="monthlyRate" placeholder="0" onChange={handleMonthlyRate}
                   type="number"/>
